...
export const Performance = () => {
  return (
    <>
      ...
      <span>
        wexium offers an easy way to control startup options regarding performance and other perfromance options you may find useful. Typically, we do not recommend editing the settings unless you know what you are doing.
      </span>
      <br></br>
      <HWAToggle />
    </>
