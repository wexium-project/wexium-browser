...
export class Store {
  ...
  @observable
  private _useAltBackground = false;

  public set useAltBackground(value: boolean) {
    this._useAltBackground = value;
    if (value) this.loadImage();
  }

  @computed
  public get useAltBackground() {
    return this._useAltBackground;
  }

  @observable
  public changeImageDaily = false;
  ...
  public async loadImage() {
    ...
    if (this.useAltBackground) {
      url = BACKGROUND_IMAGE2;
      isNewUrl = true;
    } else { 
