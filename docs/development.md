...
Now, the preferred way to communicate between processes is to use [`@wexium/rpc-electron`](https://github.com/wexond/rpc/tree/master/packages/rpc-electron) package.
